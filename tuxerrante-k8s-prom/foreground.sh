...
minikube start --kubernetes-version=v1.21.0  --feature-gates CoreDNS=true --container-runtime=docker --delete-on-failure=true --extra-config=kubelet.cgroup-driver=systemd --memory=2200mb
